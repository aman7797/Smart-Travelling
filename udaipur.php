  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="img/udaipur/Udaipur laze your evening.jpg" class="img-fluid" />
        <br/><br/>
        <p class="text-center">Laze your evening?</p>
        <center>
            <form>
...
<div class="modal fade" id="step-2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <img src="img/udaipur/Udaipur relax in natures lap.jpg" class="img-fluid" />
        <br/><br/>
        <p class="text-center">Relax in nature's lap</p>
        <center>
            <form>
            <div class="btn-group" data-toggle="buttons">
    <label class="btn btn-default form-check-label">
...
<div class="modal fade" id="step-3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <img src="img/udaipur/Udaipur check off your bucketlist.jpg" class="img-fluid" />
        <br/><br/>
        <p class="text-center">Check off your bucketlist</p>
        <center>
            <form>
            <div class="btn-group" data-toggle="buttons">
    <label class="btn btn-default form-check-label">
...
<div class="modal fade" id="step-4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <img src="img/udaipur/Udaipur experience beauty on a whole new level.jpg" class="img-fluid" />
        <br/><br/>
...
<div class="modal fade" id="step-5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog" role="document">
  	<div class="modal-content">
      <div class="modal-body">
        <img src="img/udaipur/Udaipur rich rajputana culture.jpg" class="img-fluid" />
        <br/><br/>
...
<div class="modal fade" id="step-6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <img src="img/udaipur/Udaipur indulge yourself in shoppers paradise.jpg" class="img-fluid" />
        <br/><br/>
...
<div class="modal fade" id="step-7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog" role="document">
  	<div class="modal-content">
      <div class="modal-body">
        <img src="img/udaipur/Udaipur chill relax and enjoy.jpg" class="img-fluid" />
        <br/><br/>
        <p class="text-center">Chill relax & Enjoy:D</p>
        <center>
            <form>
            <div class="btn-group" data-toggle="buttons">
    <label class="btn btn-default form-check-label">
